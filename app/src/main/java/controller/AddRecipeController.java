...
public class AddRecipeController implements Initializable {
  ...
  public void saveRecipe(ActionEvent event) {
    try {
      ...
      // adds Ingredients coresponding to the unit_id that exists in the database,
      // TODO: if the tableview has the same element twice i need to filter it.
  ...
  /**
   * generates a new Tag in the Database on enter press, then generates a new
   * Taglist to check if the next entry is already part of the database
   *
   * @param keyEvent
   * @throws SQLException
   */
